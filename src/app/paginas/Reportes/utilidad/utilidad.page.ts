...
@Component({
  ...
  templateUrl: './utilidad.page.html',
  styleUrls: ['./utilidad.page.scss'],
})
export class UtilidadPage implements OnInit {
...
ngOnInit() {  this.tableResults('99999', '', ''); }
  ...
  tableResults( idsucursal: string, fechaDesde: string , fechaHasta: string ) {
    ...
    this.jsonService.postJson('https://app.networkingsas.com/app/reportes/utilidad.php', formData).subscribe
    ((res: Array<string>) => {
      console.log(res);
