...
ngOnInit() { }
  ...
  tableResults( idsucursal: string, fechaDesde: string , fechaHasta: string, tipoIngresos: string, filtro: string ) {
    this.records = false;
    ...
    this.jsonService.postJson('https://app.networkingsas.com/app/reportes/facturacion.php', formData).subscribe
    ((res: Array<string>) => {
      console.log(res);
      if (!res) {
        this.records = false;
