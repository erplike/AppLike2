...
/* harmony import */ var _chunk_4e92c885_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-4e92c885.js */ "./node_modules/@ionic/core/dist/esm/chunk-4e92c885.js");
...
class Datetime {
    constructor(hostRef) {
        ...
        this.ionCancel = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionCancel", 7);
    ...
    async validateColumn(picker, name, index, min, max, lowerBounds, upperBounds) {
        ...
        const selectedIndex = column.selectedIndex = Object(_chunk_c90aaa66_js__WEBPACK_IMPORTED_MODULE_4__["c"])(indexMin, column.selectedIndex, indexMax);
    ...
    render() {
        ...
        Object(_chunk_c90aaa66_js__WEBPACK_IMPORTED_MODULE_4__["r"])(true, el, this.name, this.value, this.disabled);
        return (Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["H"], { onClick: this.onClick, role: "combobox", "aria-disabled": disabled ? 'true' : null, "aria-expanded": `${isExpanded}`, "aria-haspopup": "true", "aria-labelledby": labelId, class: {
                [mode]: true,
                'datetime-disabled': disabled,
                'datetime-readonly': readonly,
                'datetime-placeholder': addPlaceholderClass,
                'in-item': Object(_chunk_ba834eff_js__WEBPACK_IMPORTED_MODULE_3__["h"])('ion-item', el)
            } }, Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "datetime-text" }, datetimeText), Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: btnEl => this.buttonEl = btnEl })));
    }
...
class Picker {
    constructor(hostRef) {
         ...
         */
        this.animated = true;
        this.didPresent = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionPickerDidPresent", 7);
        this.willPresent = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionPickerWillPresent", 7);
        this.willDismiss = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionPickerWillDismiss", 7);
        this.didDismiss = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionPickerDidDismiss", 7);
    }
    onBackdropTap() {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({ [mode]: true,
                ...
                [`picker-${mode}`]: true }, Object(_chunk_ba834eff_js__WEBPACK_IMPORTED_MODULE_3__["g"])(this.cssClass)),
            style: {
    ...
    __stencil_render() {
        return [
            Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }),
            Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "picker-wrapper", role: "dialog" }, Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "picker-toolbar" }, this.buttons.map(b => (Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: buttonWrapperClass(b) }, Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "button", onClick: () => this.buttonClick(b), class: buttonClass(b) }, b.text))))), Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "picker-columns" }, Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "picker-above-highlight" }), this.presented && this.columns.map(c => Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-picker-column", { col: c })), Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "picker-below-highlight" })))
        ];
    }
    get el() { return Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["e"])(this); }
...
const buttonClass = (button) => {
    return Object.assign({ 'picker-button': true, 'ion-activatable': true }, Object(_chunk_ba834eff_js__WEBPACK_IMPORTED_MODULE_3__["g"])(button.cssClass));
};
...
class PickerColumnCmp {
    constructor(hostRef) {
        ...
        this.y = 0;
        this.noAnimate = true;
        this.ionPickerColChange = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionPickerColChange", 7);
    }
    colChanged() {
        this.refresh();
    }
    ...
    onEnd(detail) {
        ...
        this.velocity = Object(_chunk_c90aaa66_js__WEBPACK_IMPORTED_MODULE_4__["c"])(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
    ...
    refresh(forceRefresh) {
        ...
        const selectedIndex = Object(_chunk_c90aaa66_js__WEBPACK_IMPORTED_MODULE_4__["c"])(min, this.col.selectedIndex || 0, max);
    ...
    __stencil_render() {
        ...
        const Button = 'button';
        return [
            col.prefix && (Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix)),
            Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: el => this.optsEl = el }, col.options.map((o, index) => Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])(Button, { type: "button", class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "opt-index": index }, o.text))),
            col.suffix && (Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix))
        ];
    }
    get el() { return Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["e"])(this); }
    static get watchers() { return {
