...
const calcCells = (items, itemHeight, headerFn, footerFn, approxHeaderHeight, approxFooterHeight, approxItemHeight, j, offset, len) => {
    const cells = [];
...
class VirtualScroll {
    ...
    updateVirtualScroll() {
        ...
        Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["f"])(this.readVS.bind(this));
        Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["w"])(this.writeVS.bind(this));
    }
    readVS() {
    ...
    __stencil_render() {
        if (this.renderItem) {
            return (Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])(VirtualProxy, { dom: this.virtualDom }, this.virtualDom.map(node => this.renderVirtualNode(node))));
        }
        return undefined;
    }
