...
/* harmony import */ var _chunk_cae2ca23_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-cae2ca23.js */ "./node_modules/@ionic/core/dist/esm/chunk-cae2ca23.js");
...
class Searchbar {
    constructor(hostRef) {
        ...
        this.ionInput = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionInput", 7);
        ...
        this.ionClear = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionClear", 7);
    ...
    positionPlaceholder() {
        ...
        if (this.shouldAlignLeft) {
            ...
            tempSpan.innerHTML = Object(_chunk_cae2ca23_js__WEBPACK_IMPORTED_MODULE_3__["s"])(this.placeholder) || '';
    ...
    __stencil_render() {
        ...
        const cancelButton = !isCancelButtonSetToNever(this.showCancelButton) && (Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "button", tabIndex: mode === 'ios' && !this.shouldShowCancelButton() ? -1 : undefined, onMouseDown: this.onCancelSearchbar, onTouchStart: this.onCancelSearchbar, class: "searchbar-cancel-button" }, Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, mode === 'md'
            ? Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-icon", { mode: mode, icon: this.cancelButtonIcon, lazy: false })
            : this.cancelButtonText)));
        return [
            Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "searchbar-input-container" }, Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { disabled: this.disabled, ref: el => this.nativeInput = el, class: "searchbar-input", onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, placeholder: this.placeholder, type: this.type, value: this.getValue(), autoComplete: this.autocomplete, autoCorrect: this.autocorrect, spellCheck: this.spellcheck }), mode === 'md' && cancelButton, Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-icon", { mode: mode, icon: searchIcon, lazy: false, class: "searchbar-search-icon" }), Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "button", "no-blur": true, class: "searchbar-clear-button", onMouseDown: this.onClearInput, onTouchStart: this.onClearInput }, Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-icon", { mode: mode, icon: clearIcon, lazy: false, class: "searchbar-clear-icon" }))),
