...
class Chip {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({}, Object(_chunk_ba834eff_js__WEBPACK_IMPORTED_MODULE_2__["c"])(this.color), { [mode]: true, 'chip-outline': this.outline, 'ion-activatable': true })
        };
    }
    __stencil_render() {
        const mode = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this);
        return [
            ...
            mode === 'md' ? Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-ripple-effect", null) : null
        ];
    }
