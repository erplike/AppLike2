...
class Reorder {
    ...
    __stencil_render() {
        return (Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null, Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-icon", { name: "reorder", lazy: false, class: "reorder-icon" })));
    }
...
class ReorderGroup {
    constructor(hostRef) {
         ...
         */
        this.disabled = true;
        this.ionItemReorder = Object(_chunk_09ec7fc0_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this, "ionItemReorder", 7);
    }
    disabledChanged() {
        if (this.gesture) {
