...
class ProgressBar {
    ...
    hostData() {
        ...
        return {
            ...
            'aria-valuemin': 0,
            'aria-valuemax': 1,
            class: Object.assign({}, Object(_chunk_ba834eff_js__WEBPACK_IMPORTED_MODULE_2__["c"])(color), { [mode]: true, [`progress-bar-${type}`]: true, 'progress-paused': paused, 'progress-bar-reversed': document.dir === 'rtl' ? !reversed : reversed })
        };
    }
    __stencil_render() {
        ...
        const value = Object(_chunk_c90aaa66_js__WEBPACK_IMPORTED_MODULE_3__["c"])(0, this.value, 1);
        const buffer = Object(_chunk_c90aaa66_js__WEBPACK_IMPORTED_MODULE_3__["c"])(0, this.buffer, 1);
        return [
